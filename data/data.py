...
class Search:
    manufacturers_name = ['Xiaomi', 'Samsung', 'LG', 'Lenovo', 'Nike', 'Iphone']


class PageTitle:
    title_page = ('Электроника', 'Бытовая техника', 'Одежда', 'Обувь', 'Аксессуары', 'Товары для красоты',
                  'Товары для здоровья', 'Товары для дома', 'Товары для строительства и ремонта', 'Автотовары',
                  'Детские товары', 'Товары для хобби и творчества', 'Товары для взрослых',
                  'Товары для спорта и отдыха', 'Продукты питания', 'Бытовая химия и средства личной гигиены',
                  'Канцтовары', 'Зоотовары', 'Книги', 'Товары для дачи и сада')
